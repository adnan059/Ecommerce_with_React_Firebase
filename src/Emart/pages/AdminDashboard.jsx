...
const AdminDashboard = () => {
  ...
  const { getAllProducts, getAllOrders, getAllUsers } = useMyContext();
  return (
    <div>
      {/* Top */}
      ...
      <div className="px-5">
        ...
        <div className="mid mb-5">
          ...
          <div className=" bg-green-50 py-5 rounded-xl border border-green-100">
            ...
            {/* text  */}
            <div className="mt-5">
              <h1 className=" text-center text-3xl text-green-500 capitalize">
                <span className=" font-bold">Name :</span> {user?.name}
              </h1>
              <h1 className=" text-center text-3xl mt-3 text-green-500">
                <span className=" font-bold">Email :</span> {user?.email}
              </h1>
              <h1 className=" text-center text-3xl mt-3 text-green-500">
                <span className=" font-bold">Date :</span> {user?.date}
              </h1>
              <h1 className=" text-center text-3xl mt-3 text-green-500 capitalize">
            ...
            <TabList className="flex flex-wrap -m-4 text-center justify-center">
              ...
              <Tab className="p-4 md:w-1/3 sm:w-1/2 w-full cursor-pointer">
                <div className=" border bg-green-50 hover:bg-green-100 border-green-100 px-4 py-3 rounded-xl">
                  ...
                  <h2 className="title-font font-medium text-3xl text-green-400 fonts1 mt-5">
              ...
              <Tab className="p-4 md:w-1/4 sm:w-1/2 w-full cursor-pointer">
                <div className=" border bg-green-50 hover:bg-green-100 border-green-100 px-4 py-3 rounded-xl">
                  ...
                  <h2 className="title-font font-medium text-3xl text-green-700 fonts1 mt-5">
                    {getAllOrders.length === 0 ? "View" : getAllOrders.length}
                  </h2>
              ...
              <Tab className="p-4 md:w-1/3 sm:w-1/2 w-full cursor-pointer">
                <div className=" border bg-green-50 hover:bg-green-100 border-green-100 px-4 py-3 rounded-xl">
                  ...
                  <h2 className="title-font font-medium text-3xl text-green-400 fonts1 mt-5">
                    {getAllUsers.length === 0 ? "View" : getAllUsers.length}
                  </h2>
